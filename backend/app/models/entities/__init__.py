...
Market Data Models:
- SymbolInfo: Exchange-specific symbol mapping with validation and verification
- SymbolSpecs: Trading specifications (tick size, lot size, contract size) with 
               validation and periodic verification
